...
portBASE_TYPE NetTaskInit(void);
portBASE_TYPE NetJobAddFromTASK(PNETFUNC function, uint32_t arg1, uint32_t arg2);
portBASE_TYPE NetJobAddFromISR(PNETFUNC function, uint32_t arg1, uint32_t arg2);
