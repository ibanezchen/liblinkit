...
typedef enum _ENUM_PWM_CLK_T {
    ...
    PWM_CLK_XTAL,
    PWM_CLK_NUM
} __attribute__ ((__packed__)) ENUM_PWM_CLK_T, *P_ENUM_PWM_CLK_T;

typedef enum _ENUM_PWM_STATE_T {
    PWM_S0 = 0,
    PWM_S1,
    PWM_STATE_NUM
} __attribute__ ((__packed__)) ENUM_PWM_STATE_T, *P_ENUM_PWM_STATE_T;
...
typedef enum _ENUM_I2C_CLK_T {
    ...
    I2C_CLK_400K,    
    I2C_CLK_NUM
} __attribute__ ((__packed__)) ENUM_I2C_CLK_T, *P_ENUM_I2C_CLK_T;
...
typedef enum _ENUM_I2C_TRANS_STATUS_T {
    ...
    I2C_TRANS_STATUS_OK,
} __attribute__ ((__packed__)) ENUM_I2C_TRANS_STATUS_T, *P_ENUM_I2C_TRANS_STATUS_T;
