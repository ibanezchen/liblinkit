...
int32_t connsys_read_port(struct connsys_func *func, void *dst, uint32_t addr,	int32_t count);
int32_t connsys_write_port(struct connsys_func *func, uint32_t addr, void *src, int32_t count);
void connsys_write_port_start(struct connsys_func *func, uint32_t addr, int32_t total);

uint32_t connsys_readl(struct connsys_func *func, uint32_t addr, int32_t *err_ret);
void connsys_writel(struct connsys_func *func, uint32_t b, uint32_t addr, int32_t *err_ret);
uint8_t connsys_fn0_read_byte(struct connsys_func *func, uint32_t addr, int32_t *err_ret);
void connsys_fn0_write_byte(struct connsys_func *func, uint8_t b, uint32_t addr, int32_t *err_ret);
int32_t connsys_enable_func(struct connsys_func *func);
int32_t connsys_disable_func(struct connsys_func *func);
int32_t connsys_set_block_size(struct connsys_func *func, uint32_t blksz);
int32_t connsys_get_irq(struct connsys_func *func, connsys_irq_handler_t *handler);
int32_t connsys_release_irq(struct connsys_func *func);
VOID connsys_interrupt(struct connsys_func *func);
void connsys_get_bus(struct connsys_func *func);
void connsys_release_bus(struct connsys_func *func);
int32_t connsys_read_port_garbage(uint32_t addr, int32_t size);
